...
public:
     ...
     * @param onError 错误回调
     */
    void createEvent(const CalendarEventPtr &event, SuccessCallback onSuccess, ErrorCallback onError);
     ...
     * @param onError 错误回调
     */
    void updateEvent(const CalendarEventPtr &event, SuccessCallback onSuccess, ErrorCallback onError);
     ...
     * @param onError 错误回调
     */
    void deleteEvent(const QString &uid, SuccessCallback onSuccess, ErrorCallback onError);
     ...
     * @param onError 错误回调
     */
    void getEvent(const QString &uid, SuccessCallback onSuccess, ErrorCallback onError);
     ...
     * @param onError 错误回调
     */
    void getEventsForDate(const QDate &date, EventListCallback onSuccess, ErrorCallback onError);
     ...
     * @param onError 错误回调
     */
    void getEventsForDateRange(const QDate &start, const QDate &end, EventListCallback onSuccess,
