...
QQC2.ScrollView {
    ...
    function moveToSelected() {
        ...
        const currentDate = Merkuro.DateTimeState.currentDate;
        ...
        delegate: DayMouseArea {
            ...
            ColumnLayout {
                ...
                Kirigami.ListSectionHeader {
                    ...
                    visible: Merkuro.Config.showWeekHeaders &&
                ...
                GridLayout {
                    ...
                    ColumnLayout {
                        ...
                        Kirigami.AbstractCard {
                            ...
                            onClicked: scrollView.addIncidence(Merkuro.IncidenceWrapper.TypeEvent, periodStartDate)
                        }
