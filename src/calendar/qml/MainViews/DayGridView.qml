...
Item {
    ...
    property double weekHeaderWidth: Merkuro.Config.showWeekNumbers ? Kirigami.Units.gridUnit * 1.5 : 0
    ...
    property int dayWidth: Merkuro.Config.showWeekNumbers ?
    ...
    property int spacing: Merkuro.Config.monthGridBorderWidth // Between grid squares in background
    ...
    readonly property int mode: Merkuro.CalendarApplication.Event
    ...
    Loader {
        ...
        sourceComponent: Column {
            ...
            DayLabelsBar {
                ...
                anchors {
                    leftMargin: Merkuro.Config.showWeekNumbers ? weekHeaderWidth + root.spacing : 0
                    left: parent.left
                    right: parent.right
                }
            }
                ...
                Item {
                    ...
                    RowLayout {
                        ...
                        Loader {
                            ...
                            property date startDate: Merkuro.Utils.addDaysToDate(root.startDate, index * 7)

                            sourceComponent: root.weekHeaderDelegate
                            active: Merkuro.Config.showWeekNumbers
                            visible: Merkuro.Config.showWeekNumbers
