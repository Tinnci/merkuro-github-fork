...
Column {
    ...
    property date endDate: Merkuro.Utils.addDaysToDate(startDate, viewColumn.daysToShow)

    readonly property date currentDate: Merkuro.DateTimeState.currentDate
    ...
    readonly property var hourLabels: Merkuro.Utils.hourlyViewLocalisedHourLabels

    spacing: 0

    Connections {
        target: Merkuro.DateTimeState
    ...
    Row {
        ...
        Repeater {
            ...
            delegate: Rectangle {
                ...
                readonly property date headingDate: Merkuro.Utils.addDaysToDate(viewColumn.startDate, index)
                readonly property bool isToday: Merkuro.DateTimeState.isToday(headingDate)
                ...
                QQC2.Button {
                    ...
                    onClicked: {
                        Merkuro.DateTimeState.selectedDate = dayDelegate.headingDate;
    ...
    Item {
        ...
        property int actualHeight: {
            if (Merkuro.Config.weekViewAllDayHeaderHeight === -1) {
                return defaultHeight;
            } else {
                return Merkuro.Config.weekViewAllDayHeaderHeight;
            }
        }
        ...
        NumberAnimation {
            ...
            onFinished: {
                Merkuro.Config.weekViewAllDayHeaderHeight = -1;
                Merkuro.Config.save();
        ...
        Kirigami.ShadowedRectangle {
            ...
            height: Merkuro.Config.weekViewAllDayHeaderHeight !== -1 ?
        ...
        Loader {
            ...
            sourceComponent: Item {
                ...
                Repeater {
                    model: Merkuro.MultiDayIncidenceModel {
                        periodLength: viewColumn.daysToShow
                        filters: Merkuro.MultiDayIncidenceModel.AllDayOnly | Merkuro.MultiDayIncidenceModel.MultiDayOnly
                        showTodos: Merkuro.Config.showTodosInCalendarViews
                        showSubTodos: Merkuro.Config.showSubtodosInCalendarViews
                        active: viewColumn.isCurrentItem
                        model: Merkuro.IncidenceOccurrenceModel {
                            start: viewColumn.startDate
                            length: viewColumn.daysToShow
                            calendar: Merkuro.CalendarManager.calendar
                            filter: Merkuro.Filter
                        }
                    }
                                    ...
                                    ListView {
                                        ...
                                        ListView {
                                            ...
                                            delegate: Rectangle {
                                                ...
                                                readonly property date date: Merkuro.Utils.addDaysToDate(viewColumn.startDate, index)
                                                readonly property bool isToday: Merkuro.DateTimeState.isToday(date)
                                                ...
                                                DayMouseArea {
                                                    ...
                                                    DropArea {
                                                        ...
                                                        onDropped: if(viewColumn.isCurrentItem) {
                                                            ...
                                                            const incidenceWrapper = Merkuro.CalendarManager.createIncidenceWrapper();
                                                            incidenceWrapper.incidenceItem = Merkuro.CalendarManager.incidenceItem(drop.source.incidencePtr);
    ...
    ResizerSeparator {
        ...
        function setPos() {
            Merkuro.Config.weekViewAllDayHeaderHeight = allDayHeader.actualHeight;
            Merkuro.Config.save();
        }

        onDragBegin:  setPos()
        onDragReleased: setPos()
        onDragPositionChanged: allDayHeader.actualHeight = Math.min(allDayHeader.maxHeight, Math.max(allDayHeader.minHeight, Merkuro.Config.weekViewAllDayHeaderHeight + changeY))
    }
            ...
            Item {
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        model: Merkuro.HourlyIncidenceModel {
                                        ...
                                        ColumnLayout {
                                            ...
                                            Repeater {
                                                ...
                                                DropArea {
                                                    ...
                                                    z: 9999
                                                    onDropped: if(viewColumn.isCurrentItem) {
                                                        let incidenceWrapper = Merkuro.CalendarManager.createIncidenceWrapper();
                                                        ...
                                                        if(drop.source.objectName === "hourlyIncidenceDelegateBackgroundBackground") {
                                                            ...
                                                            incidenceWrapper.incidenceItem = Merkuro.CalendarManager.incidenceItem(drop.source.resizerSeparator.parent.incidencePtr);
