...
Kirigami.ShadowedRectangle {
    ...
    shadow {
        size: hovered || isOpenOccurrence ? Kirigami.Units.largeSpacing : 0
    ...
    border {
        width: 1
        color: Kirigami.ColorUtils.tintWithAlpha(Kirigami.Theme.backgroundColor, root.incidenceColor, 0.8)
    }
