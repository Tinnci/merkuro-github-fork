...
QQC2.Menu {
    ...
    QQC2.MenuItem {
        ...
        onClicked: Merkuro.CalendarManager.editCollection(actionsPopup.collectionId);
    }
    QQC2.MenuItem {
        icon.name: "view-refresh"
        text: i18nc("@action:inmenu", "Update calendar")
        onClicked: Merkuro.CalendarManager.updateCollection(actionsPopup.collectionId);
    }
    QQC2.MenuItem {
