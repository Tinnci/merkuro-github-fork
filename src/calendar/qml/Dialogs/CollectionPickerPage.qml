...
Kirigami.ScrollablePage {
    ...
    title: switch (mode) {
    case Merkuro.CalendarApplication.Todo:
        return i18n("Choose a Task Calendar");
    case Merkuro.CalendarApplication.Event:
        return i18n("Choose a Calendar");
    case Merkuro.CalendarApplication.Contact:
    ...
    property int mode: Merkuro.CalendarApplication.Event
