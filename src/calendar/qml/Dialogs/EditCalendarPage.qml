...
FormCard.FormCardPage {
    ...
    FormCard.FormCard {
        FormCard.FormCheckDelegate {
            ...
            onToggled: {
                const cachePolicy = editor.cachePolicy;
                cachePolicy.inheritFromParent = checked;
                editor.cachePolicy = cachePolicy;
                editor.save();
            }
        }
        FormCard.FormDelegateSeparator {}
        FormCard.FormCheckDelegate {
            ...
            onToggled: {
                const cachePolicy = editor.cachePolicy;
                cachePolicy.syncOnDemany = checked;
                editor.cachePolicy = cachePolicy;
                editor.save();
            }
        ...
        FormCard.FormSpinBoxDelegate {
            ...
            onValueChanged: {
                ...
                if (value === 0 && editor.cachePolicy.intervalCheckTime !== -1) {
                    cachePolicy.intervalCheckTime = -1
                    editor.cachePolicy = cachePolicy;
                    editor.save();
                } else if (editor.cachePolicy.intervalCheckTime !== value) {
                    cachePolicy.intervalCheckTime = value;
                    editor.cachePolicy = cachePolicy;
                    editor.save();
                }
            }
