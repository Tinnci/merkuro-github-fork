...
QQC2.Control {
    ...
    function setToDate(date) {
        ...
        let firstYearItemDate = yearPathView.model.data(yearPathView.model.index(1,0), Merkuro.InfiniteCalendarViewModel.StartDateRole);
        let lastYearItemDate = yearPathView.model.data(yearPathView.model.index(yearPathView.model.rowCount() - 2,0), Merkuro.InfiniteCalendarViewModel.StartDateRole);
        let firstDecadeItemDate = decadePathView.model.data(decadePathView.model.index(1,0), Merkuro.InfiniteCalendarViewModel.StartDateRole);
        let lastDecadeItemDate = decadePathView.model.data(decadePathView.model.index(decadePathView.model.rowCount() - 1,0), Merkuro.InfiniteCalendarViewModel.StartDateRole);
        ...
        if(showDays) { // Set to correct index, including creating new dates in model if needed, for the month view
            ...
            let firstMonthItemDate = monthPathView.model.data(monthPathView.model.index(1,0), Merkuro.InfiniteCalendarViewModel.FirstDayOfMonthRole);
            let lastMonthItemDate = monthPathView.model.data(monthPathView.model.index(monthPathView.model.rowCount() - 1,0), Merkuro.InfiniteCalendarViewModel.FirstDayOfMonthRole);

            while(firstMonthItemDate >= date) {
                monthPathView.model.addDates(false)
                firstMonthItemDate = monthPathView.model.data(monthPathView.model.index(1,0), Merkuro.InfiniteCalendarViewModel.FirstDayOfMonthRole);
                newMonthIndex = 0;
            }
            ...
            while(lastMonthItemDate <= date) {
                ...
                lastMonthItemDate = monthPathView.model.data(monthPathView.model.index(monthPathView.model.rowCount() - 1,0), Merkuro.InfiniteCalendarViewModel.FirstDayOfMonthRole);
            }
        ...
        while(firstYearItemDate >= date) {
            ...
            firstYearItemDate = yearPathView.model.data(yearPathView.model.index(1,0), Merkuro.InfiniteCalendarViewModel.StartDateRole);
            newYearIndex = 0;
        }
        ...
        while(lastYearItemDate <= date) {
            ...
            lastYearItemDate = yearPathView.model.data(yearPathView.model.index(yearPathView.model.rowCount() - 1,0), Merkuro.InfiniteCalendarViewModel.StartDateRole);
        }

        // Set to index and create dates if needed for decade view
        while(firstDecadeItemDate >= date) {
            decadePathView.model.addDates(false)
            firstDecadeItemDate = decadePathView.model.data(decadePathView.model.index(1,0), Merkuro.InfiniteCalendarViewModel.StartDateRole);
            newDecadeIndex = 0;
        }
        ...
        while(lastDecadeItemDate.getFullYear() <= date.getFullYear()) {
            ...
            lastDecadeItemDate = decadePathView.model.data(decadePathView.model.index(decadePathView.model.rowCount() - 1,0), Merkuro.InfiniteCalendarViewModel.StartDateRole);
        }
    ...
    contentItem: ColumnLayout {
        ...
        QQC2.SwipeView {
            ...
            PathView {
                ...
                model: Merkuro.InfiniteCalendarViewModel {
                    scale: Merkuro.InfiniteCalendarViewModel.MonthScale
                    datesToAdd: 300
                }
                ...
                delegate: Loader {
                    ...
                    sourceComponent: GridLayout {
                        ...
                        property var modelLoader: Loader {
                            asynchronous: true
                            sourceComponent: Merkuro.MonthModel {
            ...
            PathView {
                ...
                model: Merkuro.InfiniteCalendarViewModel {
                    scale: Merkuro.InfiniteCalendarViewModel.YearScale
                }
            ...
            PathView {
                ...
                model: Merkuro.InfiniteCalendarViewModel {
                    scale: Merkuro.InfiniteCalendarViewModel.DecadeScale
                }
