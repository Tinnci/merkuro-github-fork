...
TapHandler {
    ...
    property Loader colorDialogLoader: Loader {
        ...
        sourceComponent: ColorDialog {
            ...
            onAccepted: Merkuro.CalendarManager.setCollectionColor(calendarTapHandler.collectionId, color)
            onRejected: {
                close();
    ...
    property Component calendarActions: Component {
        CalendarItemMenu {
            ...
            Component.onCompleted: if(calendarTapHandler.collectionId && !calendarTapHandler.collectionDetails) {
                calendarTapHandler.collectionDetails = Merkuro.CalendarManager.getCollectionDetails(calendarTapHandler.collectionId)
            }
        }
    }
}
