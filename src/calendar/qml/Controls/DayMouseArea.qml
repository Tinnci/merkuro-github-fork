...
MouseArea {
    ...
    property string defaultType: Merkuro.IncidenceWrapper.TypeEvent
    ...
    Component {
        ...
        QQC2.Menu {
            ...
            QQC2.MenuItem {
                ...
                onClicked: addNewIncidence(Merkuro.IncidenceWrapper.TypeEvent, dayMouseArea.addDate)
            }
            QQC2.MenuItem {
                text: i18n("New Task…")
                icon.name: "view-task-add"
                onClicked: addNewIncidence(Merkuro.IncidenceWrapper.TypeTodo, dayMouseArea.addDate)
            }
        }
    }
}
