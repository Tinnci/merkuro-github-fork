...
Kirigami.ScrollablePage {
    ...
    ColumnLayout {
        Kirigami.FormLayout {
            id: contactForm
            twinFormLayouts: [addreseseForm, phoneForm, contactForm,  buisnessForm]
            Item {
        ...
        Kirigami.FormLayout {
            id: phoneForm
            twinFormLayouts: [emailForm, contactForm, buisnessForm]
            width: parent.width
        ...
        Kirigami.FormLayout {
            id: addreseseForm
            twinFormLayouts: [emailForm, formForm, contactForm, buisnessForm]
            width: parent.width
        ...
        Kirigami.FormLayout {
            id: buisnessForm 
            twinFormLayouts: [emailForm, addreseseForm, contactForm]
            width: parent.width
            ...
            Item {
                ...
                Kirigami.FormData.label: i18n("Buisness Information")
            }
