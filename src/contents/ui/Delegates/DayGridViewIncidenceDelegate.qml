...
Item {
	...
	property color selectedContentColor: LabelUtils.isDarkColor(modelData.color) ? "white" : "black"
	property color contentColor: incidenceDelegate.isOpenOccurrence ?
	    selectedContentColor : incidenceDelegate.isInCurrentMonth ?
	    textColor : otherMonthTextColor

	property int leadingIconSize: Kirigami.Units.gridUnit / 2
