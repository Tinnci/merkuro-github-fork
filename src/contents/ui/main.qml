...
Kirigami.ApplicationWindow {
    ...
    IncidenceInfoPopup {
        ...
        onOpeningIncidenceItemChanged: calculateIncidenceItemPosition()
        ...
        Connections {
            ...
            function onXChanged() { incidenceInfoPopup.calculateIncidenceItemPosition(); }
            function onYChanged() { incidenceInfoPopup.calculateIncidenceItemPosition(); }
            function onWidthChanged() { incidenceInfoPopup.calculateIncidenceItemPosition(); }
            function onHeightChanged() { incidenceInfoPopup.calculateIncidenceItemPosition(); }
        }

        Connections {
            target: incidenceInfoPopup.openingIncidenceItem.parent
            function onXChanged() { incidenceInfoPopup.calculateIncidenceItemPosition(); }
            function onYChanged() { incidenceInfoPopup.calculateIncidenceItemPosition(); }
            function onWidthChanged() { incidenceInfoPopup.calculateIncidenceItemPosition(); }
            function onHeightChanged() { incidenceInfoPopup.calculateIncidenceItemPosition(); }
