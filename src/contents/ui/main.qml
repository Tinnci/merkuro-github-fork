...
Kirigami.ApplicationWindow {
    ...
    property var editorWindowedLoaderItem: editorWindowedLoader
    Loader {
    ...
    property var filterHeaderLoaderItem: filterHeader
    Loader {
        id: filterHeader
        active: false
    ...
    property var monthScaleModelLoaderItem: monthScaleModelLoader
    Loader {
    ...
    property var weekScaleModelLoaderItem: weekScaleModelLoader
    Loader {
    ...
    property var threeDayScaleModelLoaderItem: threeDayScaleModelLoader
    Loader {
    ...
    property var dayScaleModelLoaderItem: dayScaleModelLoaderItem
    Loader {
