...
Kirigami.Page {
    ...
    readonly property real dayWidth: ((root.width - hourLabelWidth - leftPadding - scrollbarWidth) / (daysToShow - numHiddenDays)) - gridLineWidth
            ...
            sourceComponent: Column {
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        model: root.daysToShow - root.numHiddenDays
                        delegate: Rectangle {
                            width: root.dayWidth
                            ...
                            Row {
                                ...
                                Repeater {
                                    ...
                                    delegate: Item {
                                        ...
                                        visible: root.visibleDays && root.visibleDays[index]
