    ...
    PathView {
        ...
        model: Kalendar.InfiniteCalendarViewModel {
            scale: switch(root.daysToShow) {
                   case 1:
                       return Kalendar.InfiniteCalendarViewModel.DayScale
                   case 3:
                       return Kalendar.InfiniteCalendarViewModel.ThreeDayScale
                   case 7:
                   default:
                       return Kalendar.InfiniteCalendarViewModel.WeekScale
                   }
        }
        ...
        property int startIndex: model.rowCount() / 2;
