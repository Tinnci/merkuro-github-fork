            ...
            RowLayout {
                ...
                Kirigami.ActionToolBar {
                    ...
                    actions: [
                        ...
                        Kirigami.Action {
                            icon.name: KalendarApplication.iconName(toggleMenubarAction.icon)
                            text: toggleMenubarAction.text
                            shortcut: toggleMenubarAction.shortcut
                            onTriggered: toggleMenubarAction.trigger()
                        },
                        Kirigami.Action {
