...
Kirigami.OverlayDrawer {
    ...
    collapsedSize: menu.Layout.minimumWidth + Kirigami.Units.smallSpacing
    width: sidebar.collapsed ? collapsedSize : Kirigami.Units.gridUnit * 16
            ...
            Rectangle {
                ...
                MouseArea {
                    ...
                    onMouseXChanged: {
                        ...
                        if (sidebar.collapsed === false && sidebar.width < Kirigami.Units.gridUnit * 10) {
                            sidebar.collapsed = true
                            sidebar.width = sidebar.collapsedSize
                        } else if (sidebar.collapsed === true && sidebar.width > sidebar.collapsedSize) {
                            sidebar.collapsed = false
                            sidebar.width = Kirigami.Units.gridUnit * 16
                        }
                    }
                }
            }
